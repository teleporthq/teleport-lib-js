...
var Teleport = /** @class */ (function () {
    function Teleport(library, mappings, generator) {
        this.mappings = {};
        this.setLibrary(library);
        this.setMappings(mappings);
        this.setGenerator(generator);
    }
    Teleport.prototype.setLibrary = function (library) {
    ...
    Teleport.prototype.setMappings = function (mappings) {
        var maps = null;
    ...
    Teleport.prototype.setTarget = function (target) {
        this.target = target;
    };
    Teleport.prototype.setGenerator = function (generator) {
